...
const Categories = () => {
	...
	const refreshTableData = () => {
		...
		Axios.get(
			`${baseURL}/getMachines?records=${store.data.storesManagementModule.manage.perPage}&pageNo=${store.data.storesManagementModule.manage.pageNo}&colName=id&sort=asc`,
			{},
		)
			.then((response) => {
